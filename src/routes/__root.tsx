...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "حفل زفاف فارس و إسراء" },
      { name: "description", content: "دعوة زفاف فارس و إسراء — 18 مايو 2026" },
      { property: "og:title", content: "حفل زفاف فارس و إسراء" },
      { property: "og:description", content: "دعوة زفاف فارس و إسراء — 18 مايو 2026" },
